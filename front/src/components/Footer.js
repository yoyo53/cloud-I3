  ...
  >
    <div className="sm:flex sm:items-center sm:justify-between">
      ...
      <ul className="mt-8 flex justify-center gap-6 sm:mt-0 sm:justify-end">
        ...
        <li>
          <Link
            href="https://github.com/yoyo53/Y"
            rel="noreferrer"
            target="_blank"
            className="text-gray-700 transition hover:opacity-75"
          >
    ...
    >
      ...
      <Link className="font-medium text-gray-900 m-auto" href="/about">About us</Link>
      <Link className="font-medium text-gray-900 m-auto" href="/profile">Settings</Link>
    </div>

    <p className="text-xs text-gray-500">
      &copy; 2023. Y Ltd. All rights reserved.
    </p>
  </div>
</footer>
  );
