...
export default function Profile () {
  ...
  useEffect(() => {
    (async () => {
      await redirectUnautorized(router, toast);
      ...
      <div className='space-y-12'>
        <div className='border-b border-gray-900/10 pb-12'>
          ...
          <p className='mt-1 text-sm leading-6 text-gray-600'>
            Those information will be displayed publicly so be careful about
            what you share.
          </p>
        ...
        <div className='border-b border-gray-900/10 pb-12'>
          ...
          <p className='mt-1 text-sm leading-6 text-gray-600'>
            Safeguard your account with ease and manage your essential contact
            details.
          </p>
              ...
              <div className='mt-6 space-y-6'>
                <div className='relative flex gap-x-3'>
                  ...
                  <div className='text-sm leading-6'>
                    ...
                    <p className='text-gray-500'>
                      Get notified when you receive a message in one of your
                      conversations.
                    </p>
                  </div>
                </div>
                <div className='relative flex gap-x-3'>
                  ...
                  <div className='text-sm leading-6'>
                    ...
                    <p className='text-gray-500'>
                      Get notified when someones starts a new discussion with
                      you.
                    </p>
                  </div>
                </div>
